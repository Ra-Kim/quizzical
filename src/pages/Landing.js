...
export default function Landing(props){
    return(
        <StyledBg style = {{height: "100vh"}}>
            <div className="top-bubble">
                <svg width="190" height="207" viewBox="0 0 200 170" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="prompt">
                <h2>Quizzical</h2>
                <p>A quick pop quiz just for you</p>
                <button onClick={props.displayQuiz}>Start quiz</button>
            </div>
            <div className="down-bubble">
                <svg width="190" height="207" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
